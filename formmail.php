...
$TARGET_EMAIL = array($EMAIL_NAME . "@greenwichstringquartet\.co\.uk$");
...
$TEMPLATEDIR = "templates"; /* directory for template files; empty string if you don't have any templates */
